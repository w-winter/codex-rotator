...
export const OPERATION_LOCK_PATH = path.join(APP_HOME, "operation.lock");
...
export const DEFAULT_ROTATION_MAX_PRIMARY_USED_PERCENT = 60;
export const DEFAULT_ROTATION_MAX_WEEKLY_USED_PERCENT = 80;
